...
\begin{figure}[H]
  \centering  
  \includegraphics[scale=0.45]{img/charakter_mixamo}
...
\begin{figure}[H]
  ...
  \end{tabular}
  \caption{Mixamo Charakter Gangbild mit Walker Demo Gelenklimits und Gewichten}
...
\begin{figure}[H]
  \centering  
    ...
    \end{subfigure}
 \caption{Mixamo Charakter Training mit Walker Demo Gelenklimits und Gewichten}
